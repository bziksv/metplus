...
class Handlers
{
	public static function onBeforeUserAdd(&$arFields): bool
	{
		if (isset($_POST['register_submit_button']) && ($_POST['PERSONAL_DATA_CONSENT'] ?? '') !== 'Y') {
			global $APPLICATION;
			$APPLICATION->ThrowException('Необходимо дать согласие на обработку персональных данных.');
